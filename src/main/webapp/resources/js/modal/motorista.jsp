                ...
                <form class="form-horizontal">
                    <fieldset>
                        <ul class="nav nav-tabs" role="tablist">
                            <li role="presentation" class="active"><a href="#dadosMotoristaModal"  role="tab" data-toggle="tab">Dados</a></li>
                            <li role="presentation"><a href="#contatoMotoristaModal"  role="tab" data-toggle="tab">Contato</a></li>
                        </ul>
                        <!-- Tab panes -->
                        <div class="tab-content">
                            <div role="tabpanel" class="tab-pane active " id="dadosMotoristaModal">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-5">
                                        ...
                                        <input ng-model="usuarioA.cnh.numero" type="text"class="form-control input-sm" >
                                    </div>
                                    <div class="col-md-4">
                                        <label class=" control-label" for="os">Validade</label>  
                                        <input  type="text"class="form-control input-sm" ng-model="usuarioA.cnh.validade" data-date-format="dd/MM/yyyy" bs-datepicker>
                                    </div>
                                    <div class="col-md-3">
                                        <label class=" control-label" for="os">Categoria</label>  
                                        <select class="form-control input-sm" ng-model="usuarioA.cnh.categoria">
                            ...
                            <div role="tabpanel" class="tab-pane" id="contatoMotoristaModal">
                                <div class="form-group">
                                    <div class="col-md-9">
                            ...
                            <div role="tabpanel" class="tab-pane" id="historicoMotoristaModal">
                            </div>
                        </div>
                    </fieldset>
                </form>
